...
- wake-word listening remains active during uninterrupted music through the
  XVF3800 AEC output; replies and announcements are monitored only when
  barge-in is enabled so the satellite cannot wake itself
