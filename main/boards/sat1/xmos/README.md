...
cp build/satellite1_firmware_fixed_delay.factory.bin ../sat1_xmos_1_1_0_factory.bin
cp build/satellite1_firmware_fixed_delay.factory.md5 ../sat1_xmos_1_1_0_factory.md5
```

To rebuild the four-channel USB capture image after the production build has
configured the workspace:

```bash
XMOS_CLEAN_BUILD=0 SAT1_XMOS_TARGET=satellite1_usb_firmware_raw4 ./build_sat1_fixed_delay.sh
cp build/satellite1_usb_firmware_raw4.factory.bin ../sat1_xmos_1_1_0_raw4_usb_factory.bin
cp build/satellite1_usb_firmware_raw4.factory.md5 ../sat1_xmos_1_1_0_raw4_usb_factory.md5
```
