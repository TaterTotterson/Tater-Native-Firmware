...
cp build/satellite1_firmware_fixed_delay.factory.bin ../sat1_xmos_1_0_9_factory.bin
cp build/satellite1_firmware_fixed_delay.factory.md5 ../sat1_xmos_1_0_9_factory.md5
```
